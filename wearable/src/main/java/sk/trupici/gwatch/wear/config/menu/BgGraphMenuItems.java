...
public class BgGraphMenuItems {
    final public static ConfigItem[] items = {
            ...
            new BasicConfigItem(
                    ...
                    BgGraph.PREF_HYPO_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
                    R.color.def_graph_color_hypo),
            new BasicConfigItem(
                    R.string.config_item_bg_low_color_label,
                    R.drawable.config_color_edit_24,
                    BgGraph.PREF_LOW_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
                    R.color.def_graph_color_low),
            new BasicConfigItem(
                    R.string.config_item_bg_in_range_color_label,
                    R.drawable.config_color_edit_24,
                    BgGraph.PREF_IN_RANGE_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
                    R.color.def_graph_color_in_range),
            new BasicConfigItem(
                    R.string.config_item_bg_high_color_label,
                    R.drawable.config_color_edit_24,
                    BgGraph.PREF_HIGH_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
                    R.color.def_graph_color_high),
            new BasicConfigItem(
                    R.string.config_item_bg_hyper_color_label,
                    R.drawable.config_color_edit_24,
                    BgGraph.PREF_HYPER_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
                    R.color.def_graph_color_hyper),
//                new BasicConfigItem(
...
//                        R.color.def_graph_color_background),
            ...
            new BasicConfigItem(
                    ...
                    R.drawable.config_color_edit_24,
                    BgGraph.PREF_CRITICAL_LINE_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
