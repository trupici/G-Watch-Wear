...
public class BgGraphMenuItems {
    final public static ConfigItem[] items = {
            ...
            new BasicConfigItem(
                    R.string.config_item_bg_critical_color_label,
                    R.drawable.config_color_edit_24,
                    BgGraph.PREF_CRITICAL_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
                    R.color.def_graph_color_critical),
            new BasicConfigItem(
                    R.string.config_item_bg_warn_color_label,
                    R.drawable.config_color_edit_24,
                    BgGraph.PREF_WARN_COLOR,
                    ConfigItem.Type.TYPE_COLOR,
                    R.color.def_graph_color_warn),
            new BasicConfigItem(
